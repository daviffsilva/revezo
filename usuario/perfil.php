...
require('../admin/database/DatabaseUtils.php');
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" id='nome' name='nome' class="form-control" value="<?= isset($_SESSION['user']) ? $_SESSION['user']['nome'] : '' ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="email">Email:</label>
                            <input type="email" id='email' name='email' class="form-control" disabled value="<?= isset($_SESSION['user']) ? $_SESSION['user']['email'] : '' ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" id='data_nascimento' name='data_nascimento' class="form-control" value="<?= isset($_SESSION['user']) ? $_SESSION['user']['data_nascimento'] : '' ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
